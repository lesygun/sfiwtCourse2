...
class FriendsTableViewController: UITableViewController, UISearchResultsUpdating {
    ...
    override func numberOfSections(in tableView: UITableView) -> Int {
        ...
        return currentFriendTitle.count
    }

    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        let friendKey = currentFriendTitle[section]
        if let friendSecondNamesValues = currentFriendDictionary[friendKey] {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let friendKey = currentFriendTitle [indexPath.section] // из массива стрингов по индексу секции
        if let friend = currentFriendDictionary [friendKey]{
